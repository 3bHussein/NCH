            ...
            for (var i = 0; i < form.length; i++) {
                ...
                switch (obj.type) {
                    case "button":
                        ...
                        button.style.cssText = " margin-right: 6px;padding: 6px 9px; display: none; border: none;box-shadow: 0 10px 20px -10px #4801FF; background-color:rgb(107 179 92)";
                    ...
                    case "anchor":
                        ...
                        anchor.style.cssText = "border: none; background-color:rgb(107 179 92);box-shadow: 0 10px 20px -10px #ff0844;";
